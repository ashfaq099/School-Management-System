                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <form method="post" action="{{ url('admin/student/update/'.$getRecord->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" required name="class_id">
                                                ...
                                                @foreach($getClass as $value)
                                                    <option value="{{ $value->id }}" {{ $value->id == $getRecord->class_id ? 'selected' : '' }}>{{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
